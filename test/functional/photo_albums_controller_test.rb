...
class PhotoAlbumsControllerTest < ActionController::TestCase
  ...
  test "should create photo_album" do
    assert_difference('PhotoAlbum.count') do
      post :create, photo_album: { file_desc: @photo_album.file_desc, file_name: @photo_album.file_name, file_title: @photo_album.file_title, user_id: @photo_album.user_id }
    end
  ...
  test "should update photo_album" do
    put :update, id: @photo_album, photo_album: { file_desc: @photo_album.file_desc, file_name: @photo_album.file_name, file_title: @photo_album.file_title, user_id: @photo_album.user_id }
    assert_redirected_to photo_album_path(assigns(:photo_album))
  end
